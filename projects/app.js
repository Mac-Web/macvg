document.addEventListener("DOMContentLoaded", function () {
  const gamesHTML = `<a href="/macvg/projects/1/" class="game" id="game1"> 1 </a>
  ...
  <a href="/macvg/projects/infiltrating-airship/" class="game" id="game364">
...
`;
  ...
  searchInput.innerHTML = `
    <form class="side-search-input">
      <input type="text" placeholder="Search 320+ Games" class="side-search-bar" id="sideSearch">
