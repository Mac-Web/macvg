!function() {
    "use strict";
    var we, l = (we = "undefined" != typeof document && document.currentScript ? document.currentScript.src : undefined,
    function(e) {
        var t, d = void 0 !== (e = e || {}) ? e : {}, r = {};
        for (t in d)
        ...
        n = "object" == typeof process && "function" == typeof require && !p && !m,
        i = !p && !n && !m;
        var o, a, s = "";
        function g(e) {
        ...
        d.readBinary = function(e) {
            var t;
            return "function" == typeof readbuffer ? new Uint8Array(readbuffer(e)) : (T("object" == typeof (t = read(e, "binary"))),
            t)
        }
        ,
        "undefined" != typeof scriptArgs ? d.arguments = scriptArgs : void 0 !== arguments && (d.arguments = arguments),
        "function" == typeof quit && (d.quit = function(e) {
            quit(e)
        }
        )) : (p || m) && (p ? document.currentScript && (s = document.currentScript.src) : s = self.location.href,
        we && (s = we),
        ...
        function f(e) {
            var t = d["_" + e];
            return T(t, "Cannot call unknown function " + e + ", make sure it is exported"),
            t
        }
        var c = {
            stackSave: function() {
        ...
        function x(e, t) {
            ...
            if (n < 128) {
                for (var a; 0 < t; )
                    a = String.fromCharCode.apply(String, R.subarray(e, e + Math.min(t, 1024))),
                    o = o ? o + a : a,
                    e += 1024,
                    t -= 1024;
                return o
        ...
        function I(e, t) {
            for (var r = t; e[r]; )
                ++r;
            if (16 < r - t && e.subarray && C)
                return C.decode(e.subarray(t, r));
            for (var n, i, o, a, s, u = ""; ; ) {
                if (!(n = e[t++]))
                    return u;
                if (128 & n)
                    ...
                    192 != (224 & n))
                        if (o = 63 & e[t++],
                        (n = 224 == (240 & n) ? (15 & n) << 12 | i << 6 | o : (a = 63 & e[t++],
                        240 == (248 & n) ? (7 & n) << 18 | i << 12 | o << 6 | a : (s = 63 & e[t++],
                        248 == (252 & n) ? (3 & n) << 24 | i << 18 | o << 12 | a << 6 | s : (1 & n) << 30 | i << 24 | o << 18 | a << 12 | s << 6 | 63 & e[t++]))) < 65536)
        ...
        function M() {
            d.HEAP8 = y = new Int8Array(A),
            d.HEAP16 = new Int16Array(A),
            d.HEAP32 = P = new Int32Array(A),
            d.HEAPU8 = R = new Uint8Array(A),
        ...
        L < N && _("TOTAL_MEMORY should be larger than TOTAL_STACK, was " + L + "! (TOTAL_STACK=" + N + ")"),
        d.buffer ? A = d.buffer : (A = "object" == typeof WebAssembly && "function" == typeof WebAssembly.Memory ? (d.wasmMemory = new WebAssembly.Memory({
            initial: L / 65536,
            maximum: L / 65536
        }),
        d.wasmMemory.buffer) : new ArrayBuffer(L),
        d.buffer = A),
        M();
        var O = []
          , H = []
        ...
        !function ue() {
            ...
            function s(e, t, r) {
                if ("object" != typeof WebAssembly)
                    return _("no native wasm support detected"),
                    !1;
                if (!(d.wasmMemory instanceof WebAssembly.Memory))
                    return _("no native wasm Memory in use"),
                    !1;
                function n(e, t) {
                    (c = e.exports).memory && l(c.memory),
                    d.asm = c,
                    d.usingWasm = !0,
                    function r(e) {
                        if (W--,
                        d.monitorRunDependencies && d.monitorRunDependencies(W),
                        0 == W && (null !== X && (clearInterval(X),
                        X = null),
                        z)) {
                            var t = z;
                            z = null,
                ...
                d.instantiateWasm)
                    try {
                        ...
                        return _("Module.instantiateWasm callback failed with error: " + s),
                        !1
                    }
                function i(e) {
            ...
            d.asm = function(e, t, r) {
                ...
                var o;
                return t.memoryBase || (t.memoryBase = d.STATIC_BASE),
                t.tableBase || (t.tableBase = 0),
                T(o = s(0, t), "no binaryen method succeeded."),
                o
            }
        }(),
        D = 42368,
        ...
        var K = {
            ...
            decRef: function(e) {
                if (e) {
                    ...
                    T(0 < t.refcount),
                    t.refcount--,
                    0 !== t.refcount || t.rethrown || (t.destructor && d.dynCall_vi(t.destructor, e),
                    delete K.infos[e],
        ...
        F = u((w = u(D)) + N),
        P[S >> 2] = F,
        d.wasmTableSize = 4218,
        d.wasmMaxTableSize = 4218,
        d.asmGlobalArg = {},
        d.asmLibraryArg = {
            abort: se,
            ...
            ___cxa_throw: function me(e, t, r) {
                ...
                K.last = e,
                "uncaught_exception"in q ? q.uncaught_exception++ : q.uncaught_exception = 1,
            ...
            ___setErrNo: function pe(e) {
                return d.___errno_location && (P[d.___errno_location() >> 2] = e),
                e
            },
            ___syscall140: function ge(e, t) {
                ...
                try {
                    ...
                    return "undefined" != typeof FS && s instanceof FS.ErrnoError || se(s),
                    -s.errno
                }
            },
            ___syscall146: function _e(e, t) {
                ...
                try {
                    ...
                    _e.printChar = function(e, t) {
                        var r = _e.buffers[e];
                        T(r),
                        0 === t || 10 === t ? ((1 === e ? l : _)(I(r, 0)),
                        r.length = 0) : r.push(t)
                    }
                    );
                    for (var a = 0; a < i; a++) {
                        for (var s = P[n + 8 * a >> 2], u = P[n + (8 * a + 4) >> 2], h = 0; h < u; h++)
                            _e.printChar(r, R[s + h]);
                        o += u
                    }
                    return o
                } catch (c) {
                    return "undefined" != typeof FS && c instanceof FS.ErrnoError || se(c),
                    -c.errno
                }
            },
            ___syscall6: function ve(e, t) {
                ...
                try {
                    ...
                    return "undefined" != typeof FS && n instanceof FS.ErrnoError || se(n),
                    -n.errno
                }
            },
            _abort: function Te() {
            ...
            _emscripten_memcpy_big: function Ee(e, t, r) {
                return R.set(R.subarray(t, t + r), e),
                e
            },
        ...
        function ae(e) {
            ...
            0 < W || d.calledRun || (d.setStatus ? (d.setStatus("Running..."),
            setTimeout(function() {
                setTimeout(function() {
                    d.setStatus("")
                }, 1),
        ...
        ,
        (oe.prototype = new Error).constructor = oe,
        z = function De() {
            d.calledRun || ae(),
            d.calledRun || (z = De)
        }
    ...
    var d = function() {
        ...
        function i(s) {
            ...
            for (e = 0; e < t; ++e)
                this.parameters["attributeArray" + e.toString()] = {
                    defaults: [null, 0, null, !1, 0, 0],
                    setter: function() {
                        var a = e;
                        return function(e, t, r, n, i, o) {
                            null !== e && (s.bindBuffer(s.ARRAY_BUFFER, e),
                            s.vertexAttribPointer(a, t, r, n, i, o),
            ...
            for (e = 0; e < r; ++e)
                this.parameters["texture" + e.toString()] = {
        ...
        i.prototype.resolveState = function(e, t) {
            ...
            for (var r in e.changedParameters)
                e.changedParameters.hasOwnProperty(r) && (this.changedParameters.hasOwnProperty(r) && a(this.changedParameters[r], e.changedParameters[r]) || (this.changedParameters[r] = e.changedParameters[r],
        ...
        i.prototype.buildTexture = function(e, t, r, n, i, o, a, s, u) {
            ...
            return this.rebuildTexture(h, e, t, r, n, i, o, a, s, u),
            h
        }
        ,
        i.prototype.rebuildTexture = function(e, t, r, n, i, o, a, s, u, h) {
            return this.texImage2D(this.TEXTURE_2D, e, 0, t, n, i, 0, t, r, o).setTextureFiltering(this.TEXTURE_2D, e, a, s, u, h),
            this
        }
        ,
        ...
        i.prototype.createProgramFromFiles = function(o, a, s, u, e) {
            ...
            Array.isArray(a) ? t = t.concat(a) : t.push(a),
            i.loadTextFiles(t, function(e) {
                var t = [];
                if (Array.isArray(o))
        ...
        ,
        (s.prototype = Object.create(t.prototype)).constructor = t,
    ...
    function I(e, t, r, n, i) {
        ...
        for (var o = 0; o < r.length; o += 3) {
            ...
            this.triangles.push(new U(r[o + 0],r[o + 1],r[o + 2],!1))
        }
        for (o = 0; o < t.hiddenTriangles.length; ++o) {
            var s = t.hiddenTriangles[o];
            this.baseTriangles[s].hidden = !0,
            this.triangles[s].hidden = !0
        }
        for (o = 0; o < t.vertexCount; ++o)
            this.vertices.push(new H([]));
        for (o = 0; o < this.baseTriangles.length; ++o) {
            var u = this.baseTriangles[o];
            this.vertices[u.a].baseAssociations.push(new O(o,[1, 0, 0])),
            this.vertices[u.b].baseAssociations.push(new O(o,[0, 1, 0])),
            this.vertices[u.c].baseAssociations.push(new O(o,[0, 0, 1]))
        }
        function m(e, t) {
        ...
        function h(e, t) {
            ...
            for (var n, i, o, a = new H([]), s = this.vertices[e], u = this.vertices[t], h = 0; h < s.baseAssociations.length; ++h)
                for (var c = s.baseAssociations[h], l = 0; l < u.baseAssociations.length; ++l) {
                    ...
                    c.baseTriangleIndex === f.baseTriangleIndex && a.baseAssociations.push(new O(c.baseTriangleIndex,(n = c.barycentricCoordinates,
                    i = f.barycentricCoordinates,
                    o = .5,
                    [k(n[0], i[0], o), k(n[1], i[1], o), k(n[2], i[2], o)])))
                }
        ...
        for (o = 0; o < this.subdivisions; ++o) {
            for (var c = [], l = 0; l < this.triangles.length; ++l) {
                var f = (u = this.triangles[l]).a
                  ...
                  , _ = h(d, p)
                  , v = h(p, f);
                c.push(new U(f,g,v,u.hidden)),
                c.push(new U(d,_,g,u.hidden)),
                c.push(new U(p,v,_,u.hidden)),
                c.push(new U(g,_,v,u.hidden))
            }
            this.triangles = c
        }
        var T = [];
        ...
        for (o = 0; o < this.triangles.length; ++o) {
            (u = this.triangles[o]).hidden || (T[u.a] = !0,
            T[u.b] = !0,
            T[u.c] = !0)
        }
        for (o = 0; o < this.triangles.length; ++o) {
            (u = this.triangles[o]).hidden && (T[u.a] || T[u.b] || T[u.c]) && (T[u.a] ? this.vertices[u.a].isOnBorder = !0 : this.vertices[u.a].isBeyondBorder = !0,
            T[u.b] ? this.vertices[u.b].isOnBorder = !0 : this.vertices[u.b].isBeyondBorder = !0,
            T[u.c] ? this.vertices[u.c].isOnBorder = !0 : this.vertices[u.c].isBeyondBorder = !0,
            T[u.a] = !0,
            T[u.b] = !0,
            T[u.c] = !0,
            u.isBeyondBorder = !0)
        ...
        var R = [];
        for (o = 0; o < this.vertices.length; ++o)
            T[o] && R.push(this.vertices[o]);
        this.vertices = R;
        for (o = 0; o < this.triangles.length; ++o) {
            u = this.triangles[o];
            this.vertices[u.a].triangles.push(u),
            this.vertices[u.b].triangles.push(u),
            this.vertices[u.c].triangles.push(u)
        }
        var P = [0, 1, 2, 3, 4, 5];
        for (o = 0; o < this.vertices.length; ++o)
            this.vertices[o].isBeyondBorder ? this.vertices[o].neighbours = P : this.vertices[o].sortTriangles(o);
        var D = {};
        function w(e, t, r) {
            var n = m(e, t);
            if (D[n] === undefined)
        ...
        w = w.bind(this);
        for (o = 0; o < this.triangles.length; ++o) {
            w((u = this.triangles[o]).a, u.b, u.c),
            w(u.b, u.c, u.a),
            w(u.c, u.a, u.b)
        }
        var F = [0, 1, 2, 3, 4, 5];
        for (o = 0; o < this.vertices.length; ++o)
            this.vertices[o].isBeyondBorder && (this.vertices[o].opposites = F);
        var S = [];
        for (o = 0; o < this.triangles.length; ++o)
            this.triangles[o].isBeyondBorder || S.push(this.triangles[o]);
        this.triangles = S;
        for (o = 0; o < this.vertices.length; ++o) {
            var C = this.vertices[o]
              , I = C.baseAssociations[0]
              , M = (a = this.baseTriangles[I.baseTriangleIndex],
            I.barycentricCoordinates[0])
              , B = I.barycentricCoordinates[1]
              , N = I.barycentricCoordinates[2];
            C.wrinkleStrength = M * n[a.a] + B * n[a.b] + N * n[a.c],
            C.mouthiness = M * i[a.a] + B * i[a.b] + N * i[a.c],
            (C.isOnBorder || C.isBeyondBorder) && (C.wrinkleStrength = 0)
        }
        for (o = 0; o < this.vertices.length; ++o)
            for (l = 0; l < this.vertices[o].baseAssociations.length; ++l)
                this.baseTriangles[this.vertices[o].baseAssociations[l].baseTriangleIndex].wrinkleIndices.push(o)
    }
    ...
    m.prototype.update = function(e, t, r, n, i, o, a, s) {
        ...
        for (var l = 0; l < this.textureWidth * this.textureHeight; ++l)
            if (l < h.length / 3)
                this.basePositionsData[4 * l + 0] = h[3 * l + 0],
                this.basePositionsData[4 * l + 1] = h[3 * l + 1],
                this.basePositionsData[4 * l + 2] = h[3 * l + 2],
                this.basePositionsData[4 * l + 3] = 0,
                this.baseNormalsData[4 * l + 0] = c[3 * l + 0],
                this.baseNormalsData[4 * l + 1] = c[3 * l + 1],
                this.baseNormalsData[4 * l + 2] = c[3 * l + 2],
                this.baseNormalsData[4 * l + 3] = 0;
            else
                for (var f = 0; f < 4; ++f)
                    this.basePositionsData[4 * l + f] = 0,
                    this.baseNormalsData[4 * l + f] = 0;
    ...
    H.prototype.sortTriangles = function(e) {
        for (var t = [], r = this.triangles[0], n = r; t.push(n),
    ...
    var i = {
      ...
      , R = {
        ...
        slerp: function(e, t, r, n) {
            var i, o, a, s, u, h = t[0], c = t[1], l = t[2], f = t[3], d = r[0], m = r[1], p = r[2], g = r[3];
            return (o = h * d + c * m + l * p + f * g) < 0 && (o = -o,
            d = -d,
            m = -m,
            p = -p,
            g = -g),
      ...
      , P = {
        ...
        coneClamp: function(e, t, r, n) {
            ...
            if (n < i) {
                ...
                return P.multiplyByQuaternion(e, r, a),
                e
            }
            return e
        },
        rotateTowards: function(e, t, r, n) {
            ...
            return P.multiplyByQuaternion(e, t, a),
            e
        },
        add: function(e, t, r) {
            return e[0] = t[0] + r[0],
        ...
        slerp: function(e, t, r, n) {
            var i = P.dot(t, r);
            i = u(i, 0, 1);
            for (var o = Math.acos(i) * n, a = P.subtract([], r, P.multiplyByScalar([], t, i)), s = 0; s < 3; ++s)
        ...
        rgbToHSV: function(e, t) {
            var r, n, i, o, a, s = t[0], u = t[1], h = t[2], c = Math.max(s, u, h), l = c - Math.min(s, u, h), f = function(e) {
                return (c - e) / 6 / l + .5
            };
            return 0 == l ? o = a = 0 : (a = l / c,
            r = f(s),
            n = f(u),
            i = f(h),
            s === c ? o = i - n : u === c ? o = 1 / 3 + r - i : h === c && (o = 2 / 3 + n - r),
            o < 0 ? o += 1 : 1 < o && (o -= 1)),
            e[0] = o,
            e[1] = a,
            e[2] = c,
    ...
    function M(i, o) {
        function e(e) {
            for (var t = [], r = function c(e, t) {
                ...
                for (var h = [n]; r[h[h.length - 1]] !== h[0]; )
                    h.push(r[h[h.length - 1]]);
                return h
            }(i, e), n = 0; n < r.length; ++n)
                t.push(new h(r[n],i.vertices[r[n]].baseAssociations[0]));
            this.mouthRings.push(new s(e,t,o))
        }
        this.mouthRings = [],
        e = e.bind(this);
        for (var t = .5 * Math.pow(.5, i.subdivisions), r = 0; r < 1; r += t)
            e(r);
    ...
    function a(t, e, r, n, i, o, a, s) {
        ...
        t.bufferData(this.vertexBuffer, t.ARRAY_BUFFER, new Float32Array(l), t.STATIC_DRAW);
        var p = [];
        ...
        t.bufferData(this.indexBuffer, t.ELEMENT_ARRAY_BUFFER, new Uint16Array(p), t.STATIC_DRAW),
        ...
        for (f = 0; f < h * c; ++f)
            if (f < u.vertices.length) {
                for (var R = u.vertices[f], P = R.baseAssociations[0], D = u.baseTriangles[P.baseTriangleIndex], w = R.wrinkleStrength, F = R.mouthiness, S = 0; S < 4; ++S)
                    A[4 * f + S] = w,
                    y[4 * f + S] = F;
                _[4 * f + 0] = D.a,
                _[4 * f + 1] = D.b,
                _[4 * f + 2] = D.c,
                v[4 * f + (_[4 * f + 3] = 0)] = P.barycentricCoordinates[0],
                v[4 * f + 1] = P.barycentricCoordinates[1],
                v[4 * f + 2] = P.barycentricCoordinates[2],
                T[4 * f + (v[4 * f + 3] = 0)] = R.neighbours[0],
                T[4 * f + 1] = R.neighbours[1],
                T[4 * f + 2] = R.neighbours[2],
                T[4 * f + 3] = R.neighbours[3],
                E[4 * f + 0] = R.neighbours[4],
                E[4 * f + 1] = 5 < R.neighbours.length ? R.neighbours[5] : -1,
                E[4 * f + 2] = -1,
                E[4 * f + 3] = -1,
                b[4 * f + 0] = R.opposites[0],
                b[4 * f + 1] = R.opposites[1],
                b[4 * f + 2] = R.opposites[2],
                b[4 * f + 3] = R.opposites[3],
                x[4 * f + 0] = R.opposites[4],
                x[4 * f + 1] = 5 < R.opposites.length ? R.opposites[5] : -1,
                x[4 * f + 2] = -1,
                x[4 * f + 3] = -1
            } else
                for (S = 0; S < 4; ++S)
        ...
        this.wrinkleAssociationTexture = C(_),
        this.wrinkleBarycentricCoordinatesTexture = C(v),
        this.neighboursTextureA = C(T),
        this.neighboursTextureB = C(E),
        this.oppositesTextureA = C(b),
        this.oppositesTextureB = C(x),
        this.wrinkleStrengthTexture = C(A),
        this.mouthinessTexture = C(y),
        this.neighboursDistancesTextureA = C(null),
        this.neighboursDistancesTextureB = C(null),
        this.oppositesDistancesTextureA = C(null),
        this.oppositesDistancesTextureB = C(null),
        this.positionsTexture = C(null),
        this.positionsTextureTemp = C(null),
        this.normalsTexture = C(null),
        this.attachmentPositionsTexture = C(null),
        this.fixedTexture = t.buildTexture(t.RGBA, t.UNSIGNED_BYTE, h, c, null, t.CLAMP_TO_EDGE, t.CLAMP_TO_EDGE, t.NEAREST, t.NEAREST)
    }
    function g(e, t) {
        this.wgl = e,
        this.wireframe = t,
        this.attachmentPositionsProgram = e.createProgram(i["fullscreen.vert"], i["attachmentpositions.frag"], {
            a_position: 0
        }),
    ...
    function _(e, t, r, n, i) {
        ...
        for (s = 0; s < o.vertices.length; ++s) {
            ...
            h[3 * s + 1] = m.b,
            h[3 * s + 2] = m.c,
            c[3 * s + 0] = d.barycentricCoordinates[0],
            c[3 * s + 1] = d.barycentricCoordinates[1],
            c[3 * s + 2] = d.barycentricCoordinates[2],
            l[s] = f.mouthiness
        }
        this.associationsBuffer = e.buildBuffer(e.ARRAY_BUFFER, h, e.STATIC_DRAW),
        this.barycentricCoordinatesBuffer = e.buildBuffer(e.ARRAY_BUFFER, c, e.STATIC_DRAW),
        this.mouthinessesBuffer = e.buildBuffer(e.ARRAY_BUFFER, l, e.STATIC_DRAW)
    }
    s.prototype.setBasePositions = function(e, t, r) {
        for (var n = [0, 0, 0], i = .03 * -function p(e, t, r) {
            ...
            for (var a = this.mouthPoints[o].baseAssociation, s = e[a.baseTriangleIndex].a, u = e[a.baseTriangleIndex].b, h = e[a.baseTriangleIndex].c, c = a.barycentricCoordinates[0], l = a.barycentricCoordinates[1], f = a.barycentricCoordinates[2], d = 0; d < 3; ++d)
                n[d] = c * r[3 * s + d] + l * r[3 * u + d] + f * r[3 * h + d];
            P.normalize(n, n);
            for (d = 0; d < 3; ++d) {
    ...
    g.prototype.computeAttachmentPositions = function(e, t, r, n, i, o, a, s) {
        ...
        for (var c = [], l = [], f = e.mouth, d = 0; d < f.mouthRings.length; ++d) {
            ...
            for (var p = 0; p < m.mouthPoints.length; ++p) {
                ...
                c.push(g.wrinkleIndex),
                l.push(m.positions[3 * p + 0]),
                l.push(m.positions[3 * p + 1]),
                l.push(m.positions[3 * p + 2])
            }
        }
    ...
    g.prototype.update = function(e, t, r, n, i, o, a, s, u) {
        ...
        if (!this.initialized) {
            for (var l in this.wrinkleMeshes) {
                ...
                this.computeAttachmentPositions(c, c.positionsTexture, e, t, r, n, i, o),
                this.computeAttachmentPositions(c, c.attachmentPositionsTexture, e, t, r, n, i, o),
                this.computeConstraintDistance(c, c.neighboursTextureA, c.neighboursDistancesTextureA),
                this.computeConstraintDistance(c, c.neighboursTextureB, c.neighboursDistancesTextureB),
                this.computeConstraintDistance(c, c.oppositesTextureA, c.oppositesDistancesTextureA),
                this.computeConstraintDistance(c, c.oppositesTextureB, c.oppositesDistancesTextureB)
            }
            this.initialized = !0
        }
        if (this.computeAttachmentPositions(c, c.attachmentPositionsTexture, e, t, r, n, i, o),
        a) {
            var f = new Float32Array(c.rawMesh.baseTriangles[s].wrinkleIndices);
            h.bufferData(this.markBuffer, h.ARRAY_BUFFER, f, h.STATIC_DRAW),
            h.framebufferTexture2D(this.framebuffer, h.FRAMEBUFFER, h.COLOR_ATTACHMENT0, h.TEXTURE_2D, c.fixedTexture, 0),
            h.clear(h.createClearState().bindFramebuffer(this.framebuffer), h.COLOR_BUFFER_BIT);
        ...
        function m(e, t, r, n, i) {
            ...
            h.drawArrays(o, h.TRIANGLE_STRIP, 0, 4),
            v(c, "positionsTexture", "positionsTextureTemp")
        }
        m = m.bind(this);
        for (l = 0; l < 15; ++l) {
            h.framebufferTexture2D(this.framebuffer, h.FRAMEBUFFER, h.COLOR_ATTACHMENT0, h.TEXTURE_2D, c.positionsTextureTemp, 0);
            ...
            0 === l && (h.drawArrays(p, h.TRIANGLE_STRIP, 0, 4),
            v(c, "positionsTexture", "positionsTextureTemp"));
            var g = l < 14;
            m(c.neighboursTextureA, c.neighboursTextureB, c.neighboursDistancesTextureA, c.neighboursDistancesTextureB, g),
            m(c.oppositesTextureA, c.oppositesTextureB, c.oppositesDistancesTextureA, c.oppositesDistancesTextureB, g)
        }
    ...
    var B = {
        ...
        premultiply: function(e, t, r) {
            ...
            e[8] = n * T + i * E + o * b + a * x,
            e[9] = s * T + u * E + h * b + c * x,
            e[10] = l * T + f * E + d * b + m * x,
            e[11] = p * T + g * E + _ * b + v * x,
            T = t[12],
            E = t[13],
            b = t[14],
            x = t[15],
            e[12] = n * T + i * E + o * b + a * x,
            e[13] = s * T + u * E + h * b + c * x,
            e[14] = l * T + f * E + d * b + m * x,
            e[15] = p * T + g * E + _ * b + v * x,
            e
        },
        ...
        invert: function(e, t) {
            ...
            e[2] = Y * X,
            e[3] = Y * z,
            e[4] = Y * (T * n + E * i + A * o - (v * n + b * i + x * o)),
            e[5] = Y * (v * r + R * i + P * o - (T * r + y * i + D * o)),
            e[6] = Y * (b * r + y * n + F * o - (E * r + R * n + w * o)),
            e[7] = Y * (x * r + D * n + w * i - (A * r + P * n + F * i)),
            e[8] = Y * (S * p + M * g + B * _ - (C * p + I * g + N * _)),
            e[9] = Y * (C * m + L * g + H * _ - (S * m + U * g + O * _)),
            e[10] = Y * (I * m + U * p + k * _ - (M * m + L * p + G * _)),
            e[11] = Y * (N * m + O * p + G * g - (B * m + H * p + k * g)),
            e[12] = Y * (I * f + N * d + C * l - (B * d + S * l + M * f)),
            e[13] = Y * (O * d + S * c + U * f - (L * f + H * d + C * c)),
            e[14] = Y * (L * l + G * d + M * c - (k * d + I * c + U * l)),
            e[15] = Y * (k * f + B * c + H * l - (O * l + G * f + N * c)),
            e
        },
        ...
        makeLookAt: function(e, t, r, n) {
            ...
            e[10] = a,
            e[11] = 0,
            e[12] = -(u * t[0] + h * t[1] + c * t[2]),
            e[13] = -(f * t[0] + d * t[1] + m * t[2]),
    ...
    function c(e, t, r, n, i) {
        ...
        this.projectionViewMatrix = B.premultiply(new Float32Array(16), this.viewMatrix, this.projectionMatrix),
        ...
        e.renderbufferStorage(this.depthRenderbuffer, e.RENDERBUFFER, e.DEPTH_COMPONENT16, this.shadowMapWidth, this.shadowMapWidth)
    }
    function T(e, t) {
        this.wgl = e,
        this.wireframe = t,
        this.skinDepthProgram = e.createProgram(i["skindepth.vert"], i["skindepth.frag"], {
            a_textureCoordinates: 0
        }),
        this.eyeDepthProgram = e.createProgram(i["eyedepth.vert"], i["eyedepth.frag"], {
            a_position: 0
        }),
        this.hairDepthProgram = e.createProgram("#define DEPTH 1 \n" + i["hair.vert"], i["hairdepth.frag"]),
    ...
    c.prototype.recomputeViewMatrix = function() {
        ...
        B.premultiply(this.viewMatrix, this.viewMatrix, t),
        B.premultiply(this.viewMatrix, this.viewMatrix, e),
        B.premultiply(this.viewMatrix, this.viewMatrix, r)
    }
    ,
    ...
    T.prototype.renderForLight = function(e, t, r, n, i, o, a, s, u, h, c, l, f) {
        var d = this.wgl;
        d.framebufferTexture2D(this.framebuffer, d.FRAMEBUFFER, d.COLOR_ATTACHMENT0, d.TEXTURE_2D, l.depthColorTexture, 0),
        d.framebufferRenderbuffer(this.framebuffer, d.FRAMEBUFFER, d.DEPTH_ATTACHMENT, d.RENDERBUFFER, l.depthRenderbuffer),
        d.clear(d.createClearState().bindFramebuffer(this.framebuffer).clearColor(1, 1, 1, 1), d.COLOR_BUFFER_BIT | d.DEPTH_BUFFER_BIT);
    ...
    T.prototype.render = function(e, t, r, n, i, o, a, s, u, h, c, l, f) {
        for (var d = 0; d < l.length; ++d)
            this.renderForLight(e, t, r, n, i, o, a, s, u, h, c, l[d], f)
    }
    ;
    var E = [1, .37, .3];
    function t(e, t) {
    ...
    function x(e) {
        var t = function f(e) {
            ...
            for (i = 0; i < e; ++i) {
                ...
                b(r[i]),
                (h = P.multiplyByScalar([], b(r[i]), u))[3] = r[i],
                s.push(h)
            }
            var h = s[Math.floor(e / 2)];
            for (i = Math.floor(e / 2); 0 < i; --i)
                s[i] = s[i - 1];
            s[0] = h;
            var c = P.addList([], s);
            for (i = 0; i < e; ++i)
                ...
                s[i][2] /= c[2];
            var l = [.58, .2, 0];
            for (s[0][0] = 1 * (1 - l[0]) + l[0] * s[0][0],
            s[0][1] = 1 * (1 - l[1]) + l[1] * s[0][1],
            s[0][2] = 1 * (1 - l[2]) + l[2] * s[0][2],
            i = 1; i < e; ++i)
                P.multiply(s[i], s[i], l);
            return s
        }(e)
    ...
    function C(e, t) {
        ...
        this.staticSkinProgram = t.createProgram(i["staticskin.vert"], this.lightingCommons[0] + i["wrinkle.frag"]),
        ...
        this.viewMatrix = B.makeTranslation(new Float32Array(16), -this.cameraPosition[0], -this.cameraPosition[1], -this.cameraPosition[2]),
        this.lights = [new c(t,-1,0,5,1), new c(t,1,0,5,.2)],
        ...
        t.renderbufferStorage(this.depthRenderbuffer, t.RENDERBUFFER, t.DEPTH_COMPONENT16, this.canvas.width, this.canvas.height),
        this.shadowRenderer = new T(t),
        this.fov = A,
    ...
    function Q(e, t, r, n) {
        ...
        for (var i = 0; i < r.length; i += 3) {
            ...
            this.baseTriangles.push(o),
            this.triangles.push(new z(r[i + 0],r[i + 1],r[i + 2]))
        }
        for (i = 0; i < t; ++i)
            this.vertices.push(new j([]));
        for (i = 0; i < this.baseTriangles.length; ++i) {
            var a = this.baseTriangles[i];
            this.vertices[a.a].baseAssociations.push(new Y(i,[1, 0, 0])),
            this.vertices[a.b].baseAssociations.push(new Y(i,[0, 1, 0])),
            this.vertices[a.c].baseAssociations.push(new Y(i,[0, 0, 1]))
        }
        function s(e, t) {
            ...
            for (var n, i, o, a = new j([]), s = this.vertices[e], u = this.vertices[t], h = 0; h < s.baseAssociations.length; ++h)
                for (var c = s.baseAssociations[h], l = 0; l < u.baseAssociations.length; ++l) {
                    var f = u.baseAssociations[l];
                    c.baseTriangleIndex === f.baseTriangleIndex && (a.baseAssociations.push(new Y(c.baseTriangleIndex,(n = c.barycentricCoordinates,
                    i = f.barycentricCoordinates,
                    o = .5,
                    [q(n[0], i[0], o), q(n[1], i[1], o), q(n[2], i[2], o)]))),
                    1)
                }
            this.vertices.push(a);
            var d = this.vertices.length - 1;
        ...
        for (i = 0; i < e; ++i) {
            for (var u = [], h = 0; h < this.triangles.length; ++h) {
                var c = (a = this.triangles[h]).a
                  ...
                  , m = s(l, f)
                  , p = s(f, c);
                u.push(new z(c,d,p,a.hidden)),
                u.push(new z(l,m,d,a.hidden)),
                u.push(new z(f,p,m,a.hidden)),
                u.push(new z(d,m,p,a.hidden))
            }
            this.triangles = u
        }
    ...
    function Z(e, t, r, n, i) {
        ...
        for (s = 0; s < o.vertices.length; ++s) {
            ...
            c[3 * s + 1] = d.barycentricCoordinates[1],
            c[3 * s + 2] = d.barycentricCoordinates[2],
            l[3 * s + 0] = f.restPosition[0],
            l[3 * s + 1] = f.restPosition[1],
            l[3 * s + 2] = f.restPosition[2]
        }
        this.associationsBuffer = e.buildBuffer(e.ARRAY_BUFFER, h, e.STATIC_DRAW),
        this.barycentricCoordinatesBuffer = e.buildBuffer(e.ARRAY_BUFFER, c, e.STATIC_DRAW),
        this.restPositionsBuffer = e.buildBuffer(e.ARRAY_BUFFER, l, e.STATIC_DRAW)
    }
    function J(e, t) {
        this.module = e,
        this.wgl = t,
        ...
        this.perturbationTexture3D = function i(e, t) {
        ...
        }(t, this.perturbationTexture3DWidth),
    ...
    C.prototype.onResize = function() {
        ...
        e.renderbufferStorage(this.depthRenderbuffer, e.RENDERBUFFER, e.DEPTH_COMPONENT16, this.canvas.width, this.canvas.height)
    }
    ,
    ...
    C.prototype.update = function() {
        ...
        this.canvas.width > this.canvas.height ? this.projectionMatrix = B.makePerspective(new Float32Array(16), this.fov, this.canvas.width / this.canvas.height, .1, 100) : this.projectionMatrix = B.makePerspectiveHorizontal(new Float32Array(16), this.fov, this.canvas.width / this.canvas.height, .1, 100),
        this.projectionViewMatrix = B.premultiply(new Float32Array(16), this.viewMatrix, this.projectionMatrix)
    }
    ,
    C.prototype.render = function(e, t, r, n, i, o, a, s, u, h, c, l, f, d, m) {
        ...
        this.modelMatrix = e;
        var g = this.wgl;
        this.shadowRenderer.render(e, t, r, n, i, o, a, s, u, h, c, this.lights, m),
        g.framebufferTexture2D(this.framebuffer, g.FRAMEBUFFER, g.COLOR_ATTACHMENT0, g.TEXTURE_2D, this.colorTexture, 0),
        g.framebufferRenderbuffer(this.framebuffer, g.FRAMEBUFFER, g.DEPTH_ATTACHMENT, g.RENDERBUFFER, this.depthRenderbuffer),
        ...
        if (this.setLightingUniforms(v, 3),
        v.colorMask(!1, !1, !1, !1),
        g.drawElements(v, g.TRIANGLES, _.indexCount, g.UNSIGNED_SHORT, 0),
        i) {
            ...
            this.setLightingUniforms(T, 3),
            T.colorMask(!1, !1, !1, !1),
            g.drawElements(T, g.TRIANGLES, n.indexCount, g.UNSIGNED_SHORT, 0),
            T.colorMask(!0, !0, !0, !0),
            T.depthFunc(g.LEQUAL),
            g.drawElements(T, g.TRIANGLES, n.indexCount, g.UNSIGNED_SHORT, 0)
        } else {
            ...
            this.setLightingUniforms(b, 3),
            b.colorMask(!1, !1, !1, !1),
            g.drawElements(b, E.wireframe ? g.LINES : g.TRIANGLES, E.wrinkleIndexCount, g.UNSIGNED_SHORT, 0),
            b.colorMask(!0, !0, !0, !0),
            b.depthFunc(g.LEQUAL),
            g.drawElements(b, E.wireframe ? g.LINES : g.TRIANGLES, E.wrinkleIndexCount, g.UNSIGNED_SHORT, 0)
        }
        var x = function(e) {
        ...
        g.framebufferRenderbuffer(this.framebuffer, g.FRAMEBUFFER, g.DEPTH_ATTACHMENT, g.RENDERBUFFER, null);
        ...
        g.framebufferTexture2D(this.framebuffer, g.FRAMEBUFFER, g.COLOR_ATTACHMENT0, g.TEXTURE_2D, this.colorTextureTemp, 0),
        A.bindFramebuffer(this.framebuffer).uniformTexture("u_colorTexture", 0, g.TEXTURE_2D, this.colorTexture).uniform2f("u_direction", 1, 0),
        g.drawArrays(A, g.TRIANGLE_STRIP, 0, 4),
        g.framebufferTexture2D(this.framebuffer, g.FRAMEBUFFER, g.COLOR_ATTACHMENT0, g.TEXTURE_2D, this.colorTexture, 0),
        A.bindFramebuffer(this.framebuffer).uniformTexture("u_colorTexture", 0, g.TEXTURE_2D, this.colorTextureTemp).uniform2f("u_direction", 0, 1),
        g.drawArrays(A, g.TRIANGLE_STRIP, 0, 4),
        y = y.bind(this),
        g.framebufferTexture2D(this.framebuffer, g.FRAMEBUFFER, g.COLOR_ATTACHMENT0, g.TEXTURE_2D, this.colorTexture, 0),
        g.framebufferRenderbuffer(this.framebuffer, g.FRAMEBUFFER, g.DEPTH_ATTACHMENT, g.RENDERBUFFER, this.depthRenderbuffer),
        ...
        if (this.canvas.width > this.canvas.height ? R.uniform2f("u_scale", Math.tan(this.fov / 2) * this.canvas.width / this.canvas.height, Math.tan(this.fov / 2)) : R.uniform2f("u_scale", Math.tan(this.fov / 2), Math.tan(this.fov / 2) * this.canvas.height / this.canvas.width),
    ...
    W.prototype.update = function(e, t, r) {
        ...
        P.multiplyByQuaternion(this.position, this.position, r),
        P.multiplyByQuaternion(i, i, r);
        var o = P.normalize([], P.subtract([], t, this.position));
        P.coneClamp(o, i, o, 1.3),
        P.slerp(this.lookDirection, this.lookDirection, o, .7)
    }
    ,
    ...
    function ie(e, t, r) {
        ...
        var a = "object" == typeof WebAssembly
          , s = [function(t) {
            a ? (console.log("using webassembly"),
            l().then(function(e) {
                i = e,
                t()
        ...
        , function(e) {
            this.isSimplified ? (this.staticSkin = new _(o,this.baseMesh,this.baseMesh.baseIndices,this.baseMesh.wrinkleStrengths,this.baseMesh.mouthinesses),
            this.wrinkleSimulator = null) : (this.wrinkleSimulator = new g(o,!1),
        ...
        , function(e) {
            this.leftEye = new W(i,o,0),
            this.rightEye = new W(i,o,1),
            this.nose = new $(i,o),
            this.leftEar = new X(i,o,0),
            this.rightEar = new X(i,o,1),
            e()
        }
        , function(e) {
            this.renderer = new C(n,o),
            e()
        }
        , function(e) {
        ...
        s.push(function(e) {
            ...
            this.webAudioProcessor.onaudioprocess = function(e) {
                t.lastAudioProcessTime = Date.now(),
                t.heavy.process(e)
            }
            ,
        ...
        var h = 0;
        function c() {
            h < s.length ? (t(h / (s.length - 1)),
            s[h](function() {
                requestAnimationFrame(c)
            }),
            h += 1) : (this.audioParameters = {},
            this.mouseX = 0,
            this.mouseY = 0,
            this.draggingTriangleIndex = -1,
            this.lastDraggingTriangleIndex = -1,
            this.faceRotation = R.makeIdentity([]),
            ...
            .bind(this)),
            n.addEventListener("touchstart", this.onTouchStart.bind(this)),
            n.addEventListener("touchmove", this.onTouchMove.bind(this)),
            n.addEventListener("touchend", this.onTouchEnd.bind(this)),
            n.addEventListener("touchcancel", this.onTouchCancel.bind(this)),
    ...
    ie.prototype.onMouseDown = function(e) {
        ...
        var r = this.renderer.getRayDirection(this.mouseX, this.mouseY)
          ...
          , i = this.baseMesh.intersect(P.multiplyByQuaternion([], this.renderer.cameraPosition, n), P.multiplyByQuaternion([], r, n));
        -1 !== i ? (this.draggingTriangleIndex = i,
        (this.lastDraggingTriangleIndex = -1) === this.framesAtFirstDrag && (this.framesAtFirstDrag = this.framesSinceStart)) : this.draggingTriangleIndex = -1,
        this.tryUnlockAudio()
    }
    ,
    ...
    ie.prototype.onTouchEnd = function(e) {
        e.preventDefault(),
        0 < e.touches.length || this.onMouseUp({})
    }
    ,
    ...
    ie.prototype.start = function() {
        ...
        if (document.body.appendChild(e),
        e.outerHTML = document.getElementById("main-template").innerHTML,
        this.isSimplified) {
            var t = document.getElementById("quality-container");
            t.parentNode.removeChild(t)
        } else
            this.qualitySelector = new te(this.quality,function(e) {
                this.quality = e
            }
            .bind(this));
        function r() {
    ...
    ie.prototype.update = function() {
        ...
        -1 !== this.lastDraggingTriangleIndex) {
            ...
            P.length(this.baseMesh.getPosition(e)) < P.length(this.baseMesh.getRestPosition(this.lastDraggingTriangleIndex)) && (this.audioParameters.slap = 1,
            this.lastDraggingTriangleIndex = -1)
        }
        var t = [0, 0, 0];
        for (var r in this.isDragging() && (t = P.subtract([], this.baseMesh.getPosition(this.baseMesh.baseIndices[3 * this.draggingTriangleIndex]), this.baseMesh.getRestPosition(this.draggingTriangleIndex))),
        this.audioParameters.drag_delta_x = t[0],
        this.audioParameters.drag_delta_y = t[1],
        this.audioParameters.drag_delta_z = t[2],
        this.audioParameters.drag_distance = P.length(t),
        this.audioParameters)
        ...
        var i = this.renderer.getRayDirection(this.mouseX, this.mouseY)
          , o = [0, 0, 0];
        if (this.isDragging()) {
            var a, s = this.baseMesh.getRestPosition(this.draggingTriangleIndex), u = P.normalize([], s), h = P.normalize([], [u[0], u[1], 0]), c = new ne(s,[0, 0, 1]), l = new ne(s,h), f = c.intersect(this.renderer.cameraPosition, i), d = 0;
            ...
            o = new ne(P.add([], T, [0, 0, d]),[0, 0, 1]).intersect(this.renderer.cameraPosition, i),
            P.multiplyByQuaternion(o, o, v)
        } else
            a = R.identity();
        this.faceRotation = R.slerp([], this.faceRotation, a, this.isDragging() ? .1 : .05),
        ...
        this.hair.update(),
        this.leftEye.update(this.baseMesh, E, this.faceRotation),
        this.rightEye.update(this.baseMesh, E, this.faceRotation),
        this.nose.update(),
        this.leftEar.update(),
    ...
    if (null !== ae && null !== ae.getExtension("OES_texture_float") && function ue() {
        ...
        ,function() {
            ...
            window.setTimeout(function() {
                ...
                document.body.appendChild(se.canvas),
                se.start()
            }, 200)
        }
        )
