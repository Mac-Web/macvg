    ...
    var c = function() {
        ...
        c.openCampaignLink = function(d, e, f) {
            ...
            case a.BrandingDomain.Kizi:
                ...
                break;
            case a.BrandingDomain.Bild:
                return h = window.op3n(j + "www.bildspielt.de", "_blank"),
                void (h && h.focus && h.focus());
            case a.BrandingDomain.Funnygames:
                g = j + "www.funnygames.nu"
            }
            var k = "string" == typeof f ? f : b[f];
            h = window.op3n(g + "/?utm_source=" + i + "&utm_medium=html5&utm_term=" + e + "&utm_content=" + k + "&utm_campaign=Gamedistribution", "_blank"),
            h && h.focus && h.focus()
        }
        ,
    ...
    !function(a) {
        var b = function(a) {
            ...
            b.prototype.openGame = function() {
                ...
                var a = window.op3n(this.url, "_self");
                a && a.focus && a.focus()
            }
            ,
